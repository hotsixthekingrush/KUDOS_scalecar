...
class MissionMotionController(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('obstacle_radius', 0.68)

        self.declare_parameter('barrier_speed_deg', 30.0)
        self.declare_parameter('barrier_wait_closed', 3.0)
        self.declare_parameter('barrier_wait_open', 3.0)

        self.obstacle_speed = (
            self.get_parameter('obstacle_speed')
            .get_parameter_value()
            .double_value
        )

        self.obstacle_radius = (
            self.get_parameter('obstacle_radius')
            .get_parameter_value()
            .double_value
        )
        ...
        self.barrier_speed = math.radians(
            self.get_parameter('barrier_speed_deg')
            .get_parameter_value()
            .double_value
        )

        self.barrier_wait_closed = (
            self.get_parameter('barrier_wait_closed')
            .get_parameter_value()
            .double_value
        )

        self.barrier_wait_open = (
            self.get_parameter('barrier_wait_open')
            .get_parameter_value()
            .double_value
        )
